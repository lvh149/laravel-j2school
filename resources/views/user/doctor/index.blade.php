                ...
                <div class="col-md-7" style="display: flex; justify-content: space-between; align-items: center;">
                    <div class="col-lg-2 col-md-2">
                        <div class="dropdown open">
                          <button href="" class="dropdown-toggle btn btn-rose" data-toggle="dropdown" aria-expanded="true">
                            Giá 
                            <b class="caret"></b>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8" style="padding-left: 30px; color: #73777B">
                                            ...
                                            <div class="row">
                                                ...
                                                <a href="{{ route('booking.index') }}" class="btn btn-rose btn-raised btn-round" style="margin: 0 0 0 16px;">
                                                    Đặt hẹn ngay
                                                </a>
                                            </div>  
                                        </td>
